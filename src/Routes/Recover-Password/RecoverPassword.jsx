 ...
 return(
  <>
   ...
   <section className='mt-8 m-auto md:max-w-[600px] md:mt-14 md:pb-5 md:rounded-3xl md:border md:border-solid md:border-slate-50  '>
    ...
    <form onSubmit={handleSubmitRecover} action='' className='flex flex-col'>
     <p>An email has been sent to {email}</p>
     <input type="submit" value="Recover password" className='m-auto w-32 h-10 border border-slate-50 border-solid rounded-lg transition-all ease-in-out duration-100 md:text-lg md:hover:bg-red-800' />
    </form>
   </section> :
   <section className='mt-8 m-auto md:max-w-[600px] md:mt-14 md:pb-5 md:rounded-3xl md:border md:border-solid md:border-slate-50  '>
    <h2 className='text-center md:mt-5 md:text-xl'>Recover password </h2>
